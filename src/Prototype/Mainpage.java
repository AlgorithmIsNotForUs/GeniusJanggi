...
public class Mainpage extends JFrame{ 
	Image img1 = Toolkit.getDefaultToolkit().getImage("images/게임화면/bg-1.png");
	Image img2 = Toolkit.getDefaultToolkit().getImage("images/게임화면/규칙.png");
	...
	{ 
		...
		ImageIcon normal_janggi_button = new ImageIcon("images/버튼종류/십이장기버튼1.png"); //이미지들 정의
		ImageIcon press_janggi_button = new ImageIcon("images/버튼종류/십이장기버튼2.png"); //마우스 클릭될 때의 이미지
      
		ImageIcon normal_play_button = new ImageIcon("images/버튼종류/플레이버튼1.png"); //이미지들 정의
		ImageIcon press_play_button = new ImageIcon("images/버튼종류/플레이버튼2.png"); //마우스 클릭될 떄의 이미지
