package Prototype;
	...
	public class Janggi {
	   ...
	   public Janggi() {
	      ...
	      icon = new ImageIcon("images/게임화면/board.png");
	   ...
	   void setPlayerEatMal(int killedMal) { //먹히는말이 여기로 와서 JLabel로 PlayerPanel에 나타나서 보여준다.
		   ...
		   //빨간색 말을 먹는경우
		   	if(myTurn == 1) {
		         if(killedMal ==1)
		        	 MalImg = "images/십이장기빨간말/r90king.png";
		         else if(killedMal ==3)
		        	 MalImg = "images/십이장기빨간말/r0sang.png";
		         else if (killedMal ==5 || killedMal ==9)
		        	 MalImg = "images/십이장기빨간말/r0ja.png";
		         else if(killedMal==7)
		        	 MalImg = "images/십이장기빨간말/r0cha.png";
		   	}
		    //초록색 말을 먹는경우
		   	else {
		         if(killedMal == 11)
		        	 MalImg = "images/십이장기초록말/g90king.png";
		         else if(killedMal ==13)
		        	 MalImg = "images/십이장기초록말/g0sang.png";
		         else if (killedMal ==15 || killedMal ==19)
		        	 MalImg = "images/십이장기초록말/g0ja.png";
		         else if(killedMal==17)
		        	 MalImg = "images/십이장기초록말/g0cha.png";
		   	}	   	
	      ...
	      for (int i = 0; i < 4; i++) {
	         for (int j = 0; j < 3;j++) {
	            if (board[i][j] == r90king) {
	               mal r90king = new mal(i, j, "images/십이장기빨간말/r90king.png");
	               r90king.setName("images/십이장기빨간말/r90king.png");
	               Janggi.add(r90king);
	            } else if (board[i][j] == r0sang) {
	               mal r0sang = new mal(i, j, "images/십이장기빨간말/r0sang.png");
	               r0sang.setName("images/십이장기빨간말/r0sang.png");
	               Janggi.add(r0sang);
	            } else if (board[i][j] == r90sang) {
	               mal r90sang = new mal(i, j, "images/십이장기빨간말/r90sang.png");
	               r90sang.setName("images/십이장기빨간말/r90sang.png");
	               Janggi.add(r90sang);
	            } else if (board[i][j] ==r0ja) {
	               mal r0ja = new mal(i, j, "images/십이장기빨간말/r0ja.png");
	               r0ja.setName("images/십이장기빨간말/r0ja.png");
	               Janggi.add(r0ja);
	            } else if (board[i][j] == r90ja ) {
	               mal r90ja  = new mal(i, j, "images/십이장기빨간말/r90ja.png");
	               r90ja.setName("images/십이장기빨간말/r90ja.png");
	               Janggi.add(r90ja );
	            } else if (board[i][j] == r0cha) {
	               mal r0cha = new mal(i, j, "images/십이장기빨간말/r0cha.png");
	               r0cha.setName("images/십이장기빨간말/r0cha.png");
	               Janggi.add(r0cha);
	            } else if (board[i][j] == r90cha) {
	               mal r90cha = new mal(i, j, "images/십이장기빨간말/r90cha.png");
	               r90cha.setName("images/십이장기빨간말/r90cha.png");
	               Janggi.add(r90cha);
	            } else if (board[i][j] == r0who) {
	               mal r0who = new mal(i, j, "images/십이장기빨간말/r0who.png");
	               r0who.setName("images/십이장기빨간말/r0who.png");
	               Janggi.add(r0who);
	            } else if (board[i][j] == r90who) {
	               mal r90who = new mal(i, j, "images/십이장기빨간말/r90who.png");
	               r90who.setName("images/십이장기빨간말/r90who.png");
	               Janggi.add(r90who);
	            }

	            else if (board[i][j] == g90king) {
	               mal g90king = new mal(i, j, "images/십이장기초록말/g90king.png");
	               g90king.setName("images/십이장기초록말/g90king.png");
	               Janggi.add(g90king);
	            } else if (board[i][j] == g0sang) {
	               mal g0sang = new mal(i, j, "images/십이장기초록말/g0sang.png");
	               g0sang.setName("images/십이장기초록말/g0sang.png");
	               Janggi.add(g0sang);   
	            }
	            else if (board[i][j] == g90sang) {
	               mal g90sang = new mal(i, j, "images/십이장기초록말/g90sang.png");
	               g90sang.setName("images/십이장기초록말/g90sang.png");
	               Janggi.add(g90sang);
	            } else if (board[i][j] == g0ja) {
	               mal g0ja = new mal(i, j, "images/십이장기초록말/g0ja.png");
	               g0ja.setName("images/십이장기초록말/g0ja.png");
	               Janggi.add(g0ja);
	            } else if (board[i][j] == g90ja) {
	               mal g90ja = new mal(i, j, "images/십이장기초록말/g90ja.png");
	               g90ja.setName("images/십이장기초록말/g90ja.png");
	               Janggi.add(g90ja);
	            } else if (board[i][j] == g0cha) {
	               mal g0cha = new mal(i, j, "images/십이장기초록말/g0cha.png");
	               g0cha.setName("images/십이장기초록말/g0cha.png");
	               Janggi.add(g0cha);
	            } else if (board[i][j] == g90cha) {
	               mal g90cha = new mal(i, j, "images/십이장기초록말/g90cha.png");
	               g90cha.setName("images/십이장기초록말/g90cha.png");
	               Janggi.add(g90cha);
	            } else if (board[i][j] == g0who) {
	               mal g0who = new mal(i, j, "images/십이장기초록말/g0who.png");
	               g0who.setName("images/십이장기초록말/g0who.png");
	               Janggi.add(g0who);
	            } else if (board[i][j] == g90who) {
	                  mal g90who = new mal(i, j, "images/십이장기초록말/g90who.png");
	                  g90who.setName("images/십이장기초록말/g90who.png");
	                  Janggi.add(g90who);
	               }
	         }
	      }
